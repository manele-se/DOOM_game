...
class RayCasting:
    def __init__(self, game):
     ...
     # prepare objects (walls) to be rendered based on the results of ray casting and their corresponding textures.
    ...
    def get_objects_to_render(self):
        ...
        for ray, values in enumerate(self.ray_casting_result):
            ...
            # special case when the height of wall > resolution
